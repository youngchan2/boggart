...
class Experiment:
    ...
    def __init__(self, vid, hour, additional_sweeps=None, skips_qs_starts=[], skip_no_traj=False, chunk_size=150, query_seg_size=150):
        ...
        for minute in minutes:
            chunk_starts = list(range(minute, minute+150, self.chunk_size))
