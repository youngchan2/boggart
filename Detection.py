...
def execute(ingest_combos, vid, chunk_size):
    ...
    for i in range(len(ingest_combos)):
        ...
        for i in trange(
            ...
            int(1),
            leave=False,
            desc=f"{chunk_start}_{chunk_size}",
        ):
            ...
            frame_result = frame_result.rename(
                columns={
                    "xmin": "x1",
                    "ymin": "y1",
                    "xmax": "x2",
...
if __name__ == "__main__":
    ...
    minutes = list(range(0, hour*30, 150))
    param_sweeps = {"diff_thresh": [16], "peak_thresh": [0.1], "fps": [30]}
    ...
    for minute in minutes:
        chunk_starts = list(range(minute, minute + chunk_size, chunk_size))
